...
/*
    ...
    5) 서블릿이 요청을 처리(server -> doGet / doPost
        ...
        - service()가 HTTP 메서드에 따라
            doGet() - READ 또는 doPost() - CREATE, UPDATE, DELETE 호출
    ...
    7) 웹 서버거 클라이언트에게 응답 전송
        : 후처리 필렅까지 모두 끝나면
            HttpServletResponse 내용을 Http 응답 형태로 변환하여 브라우저에 전달
